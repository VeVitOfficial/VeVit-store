...
<script id="tailwind-config">tailwind.config={darkMode:"class",theme:{extend:{colors:{surface:"#131313","outline-variant":"#3c4a42","on-surface":"#e5e2e1",outline:"#86948a","surface-variant":"#353534","surface-container":"#201f1f","primary-fixed-dim":"#4edea3","surface-container-lowest":"#0e0e0e","surface-container-low":"#1c1b1b",error:"#ffb4ab",primary:"#4edea3",secondary:"#bdc7d9",background:"#131313","surface-container-highest":"#353534","on-surface-variant":"#bbcabf","on-error":"#690005","primary-container":"#10b981","on-primary-container":"#00422b","on-primary":"#003824","surface-dim":"#131313","surface-bright":"#3a3939","on-primary-fixed":"#002113","on-primary-fixed-variant":"#005236"},borderRadius:{DEFAULT:"0.125rem",lg:"0.25rem",xl:"0.5rem",full:"0.75rem"},spacing:{md:"24px",base:"8px",lg:"48px",sm:"12px",xs:"4px",margin:"32px",gutter:"24px",xl:"80px"},fontFamily:{"mono-label":["Space Grotesk"],display:["Plus Jakarta Sans"],"body-lg":["Plus Jakarta Sans"],caption:["Plus Jakarta Sans"],h2:["Plus Jakarta Sans"],h1:["Plus Jakarta Sans"],"body-md":["Plus Jakarta Sans"]},fontSize:{"mono-label":["14px",{lineHeight:"1.0",letterSpacing:"0.05em",fontWeight:"500"}],display:["48px",{lineHeight:"1.1",letterSpacing:"-0.02em",fontWeight:"800"}],"body-lg":["18px",{lineHeight:"1.6",fontWeight:"400"}],caption:["12px",{lineHeight:"1.4",fontWeight:"500"}],h2:["24px",{lineHeight:"1.3",fontWeight:"700"}],h1:["32px",{lineHeight:"1.2",fontWeight:"700"}],"body-md":["16px",{lineHeight:"1.6",fontWeight:"400"}]}}}};</script>
</head>
